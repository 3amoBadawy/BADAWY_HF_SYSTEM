...
export const CLASSES = {
  ...
  // Form Elements - Updated with !important and logical padding (ps/pe) for RTL
  input: "w-full !bg-white !text-slate-900 border border-slate-300 rounded-xl p-2.5 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all placeholder:!text-slate-400 ps-3",
  select: "w-full !bg-white !text-slate-900 border border-slate-300 rounded-xl p-2.5 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all cursor-pointer appearance-none ps-3 pe-8",
  textarea: "w-full !bg-white !text-slate-900 border border-slate-300 rounded-xl p-2.5 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all resize-none placeholder:!text-slate-400 ps-3",
